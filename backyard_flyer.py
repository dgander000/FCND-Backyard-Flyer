...
class BackyardFlyer(Drone):
    ...
    def __init__(self, connection):
        ...
        self.all_waypoints = []
        self.waypoints_calculated = False
    ...
    def local_position_callback(self):
        ...
        if self.flight_state == States.WAYPOINT:
            corrected_position = self.local_position
            corrected_position[2] = -1.0 * corrected_position[2]
            distance_to_target = np.linalg.norm(self.target_position - corrected_position)
    ...
    def calculate_box(self):
        ...
        """
        return [[10.0, 0.0,  self.target_altitude],
    ...
    def takeoff_transition(self):
        ...
        self.target_position = self.global_home
    ...
    def waypoint_transition(self):
        ...
        if self.waypoints_calculated == False:
            self.waypoints_calculated = True
